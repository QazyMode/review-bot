...
export const gitlabMrOpenedEvent: GitlabEvent = {
  ...
  project: {
    ...
    name: 'review-bot',
    description: '',
    web_url: 'https://gitlab.rosbank.rus.socgen/rb188468/review-bot',
    avatar_url:
      'https://gitlab.rosbank.rus.socgen/uploads/-/system/project/avatar/10832/raf_750x1000_075_t_FFFFFF_97ab1c12de.u2.jpg',
    git_ssh_url: 'git@gitlab.rosbank.rus.socgen:7999/rb188468/review-bot.git',
    git_http_url: 'https://gitlab.rosbank.rus.socgen/rb188468/review-bot.git',
    namespace: 'Шабанов Артем Андреевич',
    visibility_level: 10,
    path_with_namespace: 'rb188468/review-bot',
    default_branch: 'master',
    ci_config_path: null,
    homepage: 'https://gitlab.rosbank.rus.socgen/rb188468/review-bot',
    ...
    http_url: 'https://gitlab.rosbank.rus.socgen/rb188468/review-bot.git',
  },
  object_attributes: {
    assignee_id: null,
    author_id: 1179,
    ...
    updated_by_id: null,
    url: 'https://gitlab.rosbank.rus.socgen/rb188468/frontend-rmb-test/-/merge_requests/5',
    source: {
      id: 10832,
      name: 'review-bot',
      description: '',
    ...
    last_commit: {
      ...
      url:
        'https://gitlab.rosbank.rus.socgen/rb188468/frontend-rmb-test/-/commit/1d173ea7aee04e665b789a63a65f1b6920d40b99',
...
export const gitlabNewCommentInMREvent: IGitlabMergeRequestNoteEvent = {
  ...
  project: {
    ...
    web_url: 'https://gitlab.rosbank.rus.socgen/rb188468/review-bot',
    avatar_url:
      'https://gitlab.rosbank.rus.socgen/uploads/-/system/project/avatar/10832/raf_750x1000_075_t_FFFFFF_97ab1c12de....',
    git_ssh_url: 'git@gitlab.rosbank.rus.socgen:7999/rb188468/review-bot.git',
    git_http_url: 'https://gitlab.rosbank.rus.socgen/rb188468/review-bot.git',
    namespace: 'Шабанов Артем Андреевич',
    visibility_level: 10,
  ...
  object_attributes: {
    ...
    updated_by_id: null,
    description: 'kek',
    url: 'https://gitlab.rosbank.rus.socgen/rb188468/frontend-rmb-test/-/merge_requests/8#note_1017218',
  },
  repository: {
    name: 'review-bot',
    url: 'git@gitlab.rosbank.rus.socgen:7999/rb188468/review-bot.git',
  ...
  merge_request: {
    ...
    updated_at: '2020-04-15 14:47:40 UTC',
    updated_by_id: null,
    url: 'https://gitlab.rosbank.rus.socgen/rb188468/frontend-rmb-test/-/merge_requests/8',
    source: {
      id: 10832,
      name: 'review-bot',
      description: '',
    ...
    last_commit: {
      ...
      url:
        'https://gitlab.rosbank.rus.socgen/rb188468/frontend-rmb-test/-/commit/54b97a2c69d930ce954cfc450bc68af3ae4c6201',
